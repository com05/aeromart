<article id="post-27" class="post-27 page type-page status-publish hentry"	<header class="page-header">
		<h1 class="page-title"><!--누가 참여할 수 있나요?-->참여 안내</h1>
	</header><!-- .entry-header -->
	<div class="entry-content">
		<hr />
<div class="one-half">
<p class="blue-circle"><!--공급업자들과 제조업 파트너들을 만나고 싶으세요?-->공급업체와<br/>제조업체를</br>찾고 계신가요?</p>
<h3>귀사의 담당 직무분야:</h3>
<ul>
<li>공급망,</li>
<li>조달,</li>
...
<p class="green-circle">귀하의 역량, 상품, 서비스들을 판매하고 싶으세요?</p>
<h3>귀사의 담당 직무분야:</h3>
<ul>
<li>판매,</li>
<li>마케팅 사업 개발,</li>
...
<?php /* ?>
		<article id="post-27" class="post-27 page type-page status-publish hentry"	<header class="page-header">
		<h1 class="page-title">Who can attend?</h1>
	</header><!-- .entry-header -->
	<div class="entry-content">
		<hr />
<div class="one-half">
<p class="blue-circle">You want to meet suppliers and manufacturing partners?</p>
...
<li>Aviation Authorities and Regulators in these services.</li>
</ul>
<p>&nbsp;</p>
...
<div class="second-half">
<p class="green-circle">You want to sell your capabilities, products or services?</p>
